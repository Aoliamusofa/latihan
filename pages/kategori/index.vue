<template>
    <div class="container">
        ...
        <table class="styled-table">
            ...
            <tbody>
                <tr v-for="(row, index) in kategori" :key="row.kategoriId">
                
                    <td>{{ row.kategoriId }}</td>
                    <td>{{ row.kategori}}</td>
                    <td>{{ row.keterangan }}</td>
                    <td>
                        <nuxt-link :to="'/detail/' + row.kategoriId" class="button detail">Detail</nuxt-link>
                        <nuxt-link :to="'/edit/' + row.kategoriId" class="button edit">Edit</nuxt-link>
                        <nuxt-link :to="'/hapus/' + row.kategoriId" class="button delete">Hapus</nuxt-link>
                    </td>
                </tr>
            </tbody>
        </table>
...
const addKategori = async () => {
    ...
    // Clear form inputs
    newKategori.value.kategoriId = '';
    newKategori.value.kategori = '';
    newKategori.value.keterangan = '';
